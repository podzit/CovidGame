...
Si au cours du jeu, la poche atteint 500$ et plus, à la fin de la partie, le joueur peut enregistrer son pseudo et son score pour apparaitre dans le tableau "High Score" (page `scores.php`) qui affiche les 10 meilleurs.
