...
function jeu() {
    ...
    var html = "\<table style\=\"border\-collapse\: collapse\; width\: 50\%\;\" border\=\"0\" align\=\"center\"\>\<tbody\>\<tr\>\<td style\=\"width\: 50\%\; text\-align\: center\;\"\>\<div align\=\"center\"\>";
    var html2 = "\<\/div\>\<\/td\>\<td style\=\"width\: 10\%\;\"\>\&nbsp\;\<\/td\>\<td style\=\"width\: 50\%\; text\-align\: center\;\"\>\<div align\=\"center\"\>";
    var html3 = "\<\/div\>\<\/td\>\<\/tr\>\<\/tbody\>\<\/table\>";
    ...
    if (random == 3){valeur1 = 3};
    if (random == 4){valeur1 = 3};
    if (random == 5){valeur1 = 4};
    if (random == 6){valeur1 = 4};
    if (random == 7){valeur1 = 5};
    if (random == 8){valeur1 = 5};
    if (random == 9){valeur1 = 6};
    if (random == 10){valeur1 = 1};
    if (random == 11){valeur1 = 2};
    if (random == 12){valeur1 = 3};
    if (random == 13){valeur1 = 3};
    if (random == 14){valeur1 = 4};
    if (random == 15){valeur1 = 4};
    if (random == 16){valeur1 = 5};
    if (random == 17){valeur1 = 5};
    if (random == 18){valeur1 = 6};
    if (random2 == 1){valeur2 = 1};
    if (random2 == 2){valeur2 = 2};
    if (random2 == 3){valeur2 = 3};
    if (random2 == 4){valeur2 = 3};
    if (random2 == 5){valeur2 = 4};
    if (random2 == 6){valeur2 = 4};
    if (random2 == 7){valeur2 = 5};
    if (random2 == 8){valeur2 = 5};
    if (random2 == 9){valeur2 = 6};
    if (random2 == 10){valeur2 = 1};
    if (random2 == 11){valeur2 = 2};
    if (random2 == 12){valeur2 = 3};
    if (random2 == 13){valeur2 = 3};
    if (random2 == 14){valeur2 = 4};
    if (random2 == 15){valeur2 = 4};
    if (random2 == 16){valeur2 = 5};
    if (random2 == 17){valeur2 = 5};
    if (random2 == 18){valeur2 = 6};
    ...
    var centre = "\<p style\=\"text\-align\: center\;\"\>";
    var centrefin = "\<\/p\>";
    ...
    var body = affimg + centre + result + centrefin;
