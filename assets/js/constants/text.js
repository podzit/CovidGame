...
export const text = {
    ...
    captchaError: [`Captcha invalide, la proposition n'a pas été envoyée.`],
    thanx: [`Merci, ta carte va être étudiée avec le plus grand sérieux.`],
    gameOver: [`GAME OVER !<br>`],
    replay: [`Tu retentes ta chance ou tu abandonnes ?`],
    pocket: [`Ta poche: `],
